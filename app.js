...
const prayersData = [
    ...
    {
        id: "yasin",
        title: "Yasin Suresi (İlk Sayfa)",
        arabic: "يس<br>وَالْقُرْآنِ الْحَكِيمِ<br>إِنَّكَ لَمِنَ الْمُرْسَلِينَ<br>عَلَى صِرَاطٍ مُسْتَقِيمٍ<br>تَنزِيلَ الْعَزِيزِ الرَّحِيمِ<br>لِتُنذِرَ قَوْمًا مَّا أُنذِرَ آبَاؤُهُمْ فَهُمْ غَافِلُونَ<br>لَقَدْ حَقَّ الْقَوْلُ عَلَى أَكْثَرِهِمْ فَهُمْ لَا يُؤْمِنُونَ<br>إِنَّا جَعَلْنَا فِي أَعْنَاقِهِمْ أَغْلاَلاً فَهِيَ إِلَى الأَذْقَانِ فَهُم مُّقْمَحُونَ<br>وَجَعَلْنَا مِن بَيْنِ أَيْدِيهِمْ سَدًّا وَمِنْ خَلْفِهِمْ سَدًّا فَأَغْشَيْنَاهُمْ فَهُمْ لاَ يُبْصِرُونَ<br>وَسَوَاء عَلَيْهِمْ أَأَنذَرْتَهُمْ أَمْ لَمْ تُنذِرْهُمْ لاَ يُؤْمِنُونَ<br>إِنَّمَا تُنذِرُ مَنِ اتَّبَعَ الذِّكْرَ وَخَشِيَ الرَّحْمَن بِالْغَيْبِ فَبَشِّرْهُ بِمَغْفِرَةٍ وَأَجْرٍ كَرِيمٍ",
        reading: "1. Yâ-Sîn<br>2. Ve-Kur'ân-il Hakîm<br>3. İnneke leminel murselîn<br>4. Alâ sırâtın müstekîm<br>5. Tenzîlel azîzir-Rahîm<br>6. Li tünzira kavmen mâ ünzira âbâühüm fehüm ğâfilûn<br>7. Lekad hakkal kavlü alâ ekserihim fehüm lâ yü'minûn<br>8. İnnâ cealnâ fî a'nâkıhim ağlâlen fehiye ilel ezkâni fehüm mukmehûn<br>9. Ve cealnâ min beyni eydîhim sedden ve min halfihim sedden fe ağşeynâhüm fehüm lâ yübsirûn<br>10. Ve sevâün aleyhim eenzertehüm em lem tünzirhüm lâ yü'minûn<br>11. İnnemâ tünziru menittebeaz zikra ve haşiyer rahmâne bil-ğaybi fe beşşirhü bi mağfiratin ve ecrin kerîm",
        meaning: "1. Yâ Sîn.<br>2. Hikmet dolu Kur'an'a andolsun ki,<br>3. Sen elbette gönderilmiş (peygamber)lerdensin.<br>4. Dosdoğru bir yol üzeresin.<br>5. (Bu Kur'an) mutlak güç sahibi, çok merhametli Allah tarafından indirilmiştir.<br>6. Ataları uyarılmamış, bu yüzden de gaflet içinde kalmış bir kavmi uyarman için gönderildin.<br>7. Andolsun ki onların çoğu üzerine o söz (azap hükmü) hak olmuştur. Artık onlar iman etmezler.<br>8. Biz onların boyunlarına demir halkalar geçirdik, o halkalar çenelerine dayanmıştır. Bu yüzden kafaları yukarı kalkıktır.<br>9. Biz, önlerinden bir set ve arkalarından bir set çekip de onları çepeçevre kuşattık. Bu yüzden artık göremezler.<br>10. Onları uyarsan da uyarmasan da onlar için birdir, inanmazlar.<br>11. Sen ancak Zikr'e (Kur'an'a) uyanı ve görmediği halde Rahmân'dan korkan kimseyi uyarırsın. İşte onu bir bağışlanma ve güzel bir mükafatla müjdele."
    },
    {
        id: "ihlas",
